...
export default function SettingsPage() {
  ...
  return (
    <div className="px-4 py-5 max-w-lg mx-auto">
      ...
      {toast && (
        <div
          className="fixed top-12 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-lg text-sm font-medium shadow-lg transition-opacity duration-300"
          style={{
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="glass-card p-4 flex flex-col gap-2">
            ...
            <input
              ...
              onChange={(e) =>
                setConfig((c) => ({ ...c, llm_base_url: e.target.value }))
              }
